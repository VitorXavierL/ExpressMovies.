...
return (
      <>
        <form onSubmit={handleSubmit} className="bg-red-900 text-zinc-400 font-bold p-20 rounded-lg">
            <h2 className="font-bold text-gray-15  text-4xl">Diretores🎞🎥</h2>
            <label className="m-4">Nome:</label>
            <input type="text" name="nome" id="nome" placeholder="Nome do Diretor" value={form.nome} onChange={handleChange} required/><br />
            <label className="m-4">Data de Nascimento: </label>
            ...
            <button type="submit" className="bg-gray-500 p-3 rounded-lg">Adicionar Diretor</button>
        </form>
      </>
)
}